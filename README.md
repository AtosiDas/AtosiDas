...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=AtosiDas&label=Profile%20Views&color=0e75b6&style=flat" alt="profile views" />
</p>
...
- LLM-powered **chatbots** and personalized conversational agents  
- OpenAI, Gemini, LLaMA, RAG architectures  
- Embeddings, vector databases, LangChain, retrieval pipelines  
- Model prompting, finetuning, and evaluation  
...
- Cryptographic primitives (ECC, hashing, signatures)  
...
- **Blockchain-enabled Distributed Payment Card Tokenization**  
  Published in **IEEE INDISCON 2024**
...
<a href="https://github.com/AtosiDas" target="_blank">
...
<h3 align="center">✨ Open to opportunities in AI Engineering, Blockchain Development, and Security Research.</h3>
